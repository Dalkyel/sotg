const links = [
    ...
    { source: 'orka', target: 'drekr-cazadora', label: 'protagoniza', type: 'event' },
    ...
    { source: 'orka', target: 'raid-camara-sigrun', label: 'protagoniza', type: 'event' },
    ...
    // Thorkel
    { source: 'thorkel', target: 'virk', label: 'comercian', type: 'rel' },
    ...
    { source: 'virk', target: 'holmganga-event', label: 'combatiente y violó las reglas', type: 'event' },
    ...
    // Rokia
    { source: 'rokia', target: 'varg', label: 'entrena', type: 'rel' },
    ...
    { source: 'elvar', target: 'biorr', label: 'relación romántica', type: 'rel' },
    ...
    { source: 'elvar', target: 'reunion-storr-elvar', label: 'protagoniza', type: 'event' },
    ...
    { source: 'battle-grim', target: 'sjavarom', label: 'Pelearon contra', type: 'event' },
    // grend
    ...
    { source: 'berak-venta', target: 'wave-jarl', label: 'navegado en', type: 'geo' },
    ...
    { source: 'llegada-snakavik', target: 'agnar', label: 'organizada por', type: 'event' },
    ...
    { source: 'fuga-fiordo', target: 'orka', label: 'protagoniza', type: 'event' },
    ...
    { source: 'varg-primera-muerte', target: 'varg', label: 'protagonizada por', type: 'event' },
    ...
    { source: 'tumulo-thorkel', target: 'drekr-cazadora', label: 'voto que lanza la', type: 'event' },
    ...
    { source: 'consulta-hrung', target: 'elvar', label: 'protagoniza', type: 'event' },
    ...
    { source: 'mision-briefing-skalk', target: 'skalk', label: 'protagonizado por', type: 'event' },
    ...
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 31 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'viaje-darl', target: 'orka', label: 'protagoniza', type: 'event' },
    { source: 'viaje-darl', target: 'mord-lif', label: 'entrenados durante el', type: 'event' },
    { source: 'viaje-darl', target: 'darl', label: 'destino final del', type: 'geo' },
    { source: 'viaje-darl', target: 'ilska', label: 'mencionada como luchadora de leyenda en', type: 'lore' },
    { source: 'llegada-darl', target: 'orka', label: 'protagoniza', type: 'event' },
    { source: 'llegada-darl', target: 'darl', label: 'escenario de la', type: 'geo' },
    { source: 'llegada-darl', target: 'helka', label: 'desembarca en', type: 'event' },
    { source: 'llegada-darl', target: 'hakon', label: 'avistado en', type: 'event' },
    { source: 'llegada-darl', target: 'enviado-iskidan', label: 'avistado en', type: 'event' },
    { source: 'llegada-darl', target: 'ulfhednar', label: 'escolta de Helka en', type: 'event' },
    { source: 'despedida-mord-lif', target: 'orka', label: 'protagoniza', type: 'event' },
    { source: 'despedida-mord-lif', target: 'mord-lif', label: 'separación sellada en', type: 'event' },
    { source: 'despedida-mord-lif', target: 'darl', label: 'escenario de la', type: 'geo' },
    { source: 'enviado-iskidan', target: 'iskidan', label: 'representa a', type: 'rel' },
    { source: 'enviado-iskidan', target: 'helka', label: 'viaja con la flota de', type: 'event' },
    { source: 'enviado-iskidan', target: 'darl', label: 'llega a', type: 'geo' },
    { source: 'orka', target: 'darl', label: 'entra sola en busca de Breca', type: 'trama' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 32 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'revelacion-oskutred-battle-grim', target: 'agnar', label: 'liderada por', type: 'event' },
    { source: 'revelacion-oskutred-battle-grim', target: 'elvar', label: 'presente en la', type: 'event' },
    { source: 'revelacion-oskutred-battle-grim', target: 'biorr', label: 'presente en la', type: 'event' },
    { source: 'revelacion-oskutred-battle-grim', target: 'uspa', label: 'fuente del secreto en la', type: 'event' },
    { source: 'revelacion-oskutred-battle-grim', target: 'oskutred', label: 'destino revelado en la', type: 'trama' },
    { source: 'revelacion-oskutred-battle-grim', target: 'lake-horndal', label: 'escenario de la', type: 'geo' },
    { source: 'revelacion-oskutred-battle-grim', target: 'battle-grim', label: 'compañía convocada en la', type: 'event' },
    { source: 'biorr-elvar-beso', target: 'biorr', label: 'protagoniza', type: 'event' },
    { source: 'biorr-elvar-beso', target: 'elvar', label: 'protagoniza', type: 'event' },
    { source: 'biorr-elvar-beso', target: 'grend', label: 'interrumpido por', type: 'event' },
    { source: 'lake-horndal', target: 'vigrið', label: 'parte de', type: 'geo' },
    { source: 'lake-horndal', target: 'llanura-batalla-norte', label: 'puerta de entrada a la', type: 'geo' },
    { source: 'starl', target: 'lake-horndal', label: 'a orillas del', type: 'geo' },
    { source: 'starl', target: 'wave-jarl', label: 'abastece al', type: 'event' },
    { source: 'llanura-batalla-norte', target: 'gudfall', label: 'epicentro del', type: 'lore' },
    { source: 'llanura-batalla-norte', target: 'oskutred', label: 'Oskutreð se encuentra en la', type: 'lore' },
    { source: 'wave-jarl', target: 'lake-horndal', label: 'cruzó el', type: 'geo' },
    { source: 'elvar', target: 'ilska', label: 'sospecha Tainted sin collar en las filas de', type: 'trama' },
    { source: 'huld', target: 'battle-grim', label: 'miembro de los', type: 'rel' },
    { source: 'solin', target: 'battle-grim', label: 'miembro de los', type: 'rel' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 33 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'busqueda-drekr-darl', target: 'orka', label: 'protagoniza la', type: 'event' },
    { source: 'busqueda-drekr-darl', target: 'darl', label: 'escenario de la', type: 'geo' },
    { source: 'busqueda-drekr-darl', target: 'drekr', label: 'objetivo de la', type: 'trama' },
    { source: 'busqueda-drekr-darl', target: 'hombre-quemado', label: 'revela al', type: 'event' },
    { source: 'hombre-quemado', target: 'dead-drengr', label: 'conduce a Orka hasta el', type: 'event' },
    { source: 'hombre-quemado', target: 'drekr', label: 'agente de', type: 'rel' },
    { source: 'rescate-ninos-canal', target: 'orka', label: 'protagoniza el', type: 'event' },
    { source: 'rescate-ninos-canal', target: 'ninos-robados', label: 'descubre operación activa de', type: 'trama' },
    { source: 'rescate-ninos-canal', target: 'bersi', label: 'Orka mata a', type: 'event' },
    { source: 'rescate-ninos-canal', target: 'dead-drengr', label: 'escenario trasero del', type: 'geo' },
    { source: 'rescate-ninos-canal', target: 'nino-mayor-canal', label: 'libera a', type: 'event' },
    { source: 'dead-drengr', target: 'drekr', label: 'Drekr opera desde', type: 'trama' },
    { source: 'dead-drengr', target: 'darl', label: 'ubicado en', type: 'geo' },
    { source: 'dead-drengr', target: 'hakon', label: 'protegido por drengrs de Helka al mando de', type: 'trama' },
    { source: 'dead-drengr', target: 'helka', label: 'guardia exterior de', type: 'rel' },
    { source: 'bersi', target: 'drekr', label: 'hombre de', type: 'rel' },
    { source: 'bersi', target: 'ninos-robados', label: 'transportaba niños de la red de', type: 'trama' },
    { source: 'orka', target: 'drekr', label: 'converge sobre en El Drengr Muerto', type: 'trama' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 34 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'saga-queso-troll', target: 'svik', label: 'protagoniza la', type: 'lore' },
    { source: 'ella-misteriosa', target: 'vol', label: 'esperada por', type: 'trama' },
    { source: 'ella-misteriosa', target: 'glornir', label: 'preocupación de', type: 'trama' },
    { source: 'ella-misteriosa', target: 'bloodsworn', label: 'esperaba reunirse con los', type: 'trama' },
    { source: 'varg', target: 'akall', label: 'necesita / tercer intento fallido del', type: 'trama' },
    { source: 'torvik', target: 'varg', label: 'llamó hermano a', type: 'rel' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 35 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'combate-dead-drengr', target: 'orka', label: 'protagoniza el', type: 'event' },
    { source: 'combate-dead-drengr', target: 'drekr', label: 'primer encuentro directo con', type: 'event' },
    { source: 'combate-dead-drengr', target: 'hakon', label: 'expuesto en el', type: 'event' },
    { source: 'combate-dead-drengr', target: 'mord-lif', label: 'rescatan a Orka en el', type: 'event' },
    { source: 'combate-dead-drengr', target: 'dead-drengr', label: 'escenario del', type: 'geo' },
    { source: 'combate-dead-drengr', target: 'colgante-espada', label: 'Orka recupera el', type: 'event' },
    { source: 'orka-poder-oculto', target: 'orka', label: 'primera manifestación en', type: 'trama' },
    { source: 'orka-poder-oculto', target: 'tainted', label: 'posible manifestación de sangre', type: 'trama' },
    { source: 'garras-drekr', target: 'drekr', label: 'cicatrices en la cara de', type: 'trama' },
    { source: 'garras-drekr', target: 'breca', label: '¿posiblemente causadas por?', type: 'trama' },
    ...
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 38 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'apertura-isbrun', target: 'uspa', label: 'activado por', type: 'event' },
    { source: 'apertura-isbrun', target: 'isbrun', label: 'resulta en la apertura del', type: 'event' },
    { source: 'apertura-isbrun', target: 'foso-vaesen', label: 'permite cruzar el', type: 'event' },
    { source: 'ataque-tennur-colina', target: 'tennur', label: 'enjambre atacante en el', type: 'event' },
    { source: 'ataque-tennur-colina', target: 'elvar', label: 'protagoniza el', type: 'event' },
    { source: 'ataque-tennur-colina', target: 'grend', label: 'Grend cae inconsciente en el', type: 'event' },
    { source: 'ataque-tennur-colina', target: 'biorr', label: 'Biórr rescata a Elvar y Grend en el', type: 'event' },
    { source: 'ataque-tennur-colina', target: 'solin', label: 'Sólín salvada por Elvar en el', type: 'event' },
    { source: 'isbrun', target: 'foso-vaesen', label: 'cruza el', type: 'geo' },
    { source: 'isbrun', target: 'oskutred', label: 'puerta de acceso hacia', type: 'geo' },
    { source: 'foso-vaesen', target: 'gudfall', label: 'creado durante el', type: 'lore' },
    { source: 'foso-vaesen', target: 'eldrafell', label: 'al sur de', type: 'geo' },
    { source: 'colinas-luna-oscura', target: 'oskutred', label: 'señalan la dirección a', type: 'geo' },
    { source: 'colinas-luna-oscura', target: 'eldrafell', label: 'al este de', type: 'geo' },
    { source: 'amenaza-horizonte-sur', target: 'agnar', label: 'avistada por', type: 'event' },
    { source: 'amenaza-horizonte-sur', target: 'llanura-batalla-norte', label: 'detectada en la', type: 'geo' },
    { source: 'gytha-grend', target: 'grend', label: 'herida no resuelta de', type: 'trama' },
    { source: 'gytha-grend', target: 'gytha', label: 'involucra a', type: 'rel' },
    { source: 'uspa', target: 'isbrun', label: 'activó con sangre Tainted el', type: 'magic' },
    { source: 'battle-grim', target: 'isbrun', label: 'cruzó el', type: 'event' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 39 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'cadena-ulfrir', target: 'ulfrir', label: 'ató y permitió la muerte de', type: 'lore' },
    { source: 'cadena-ulfrir', target: 'likrafa', label: 'forjada con Seiðr por', type: 'lore' },
    { source: 'cadena-ulfrir', target: 'collares', label: 'origen del material de los', type: 'lore' },
    { source: 'cadena-ulfrir', target: 'darl', label: 'fragmento hallado donde se fundó', type: 'lore' },
    { source: 'cadena-ulfrir', target: 'snakavik', label: 'fragmento hallado donde se fundó', type: 'lore' },
    { source: 'pelo-froya', target: 'froya', label: 'pertenece a', type: 'rel' },
    { source: 'pelo-froya', target: 'varg', label: 'guardado por', type: 'rel' },
    { source: 'pelo-froya', target: 'akall', label: 'objeto vinculante para el', type: 'magic' },
    { source: 'oferta-torvik-akall', target: 'torvik', label: 'hecha por', type: 'event' },
    { source: 'oferta-torvik-akall', target: 'varg', label: 'recibida por', type: 'event' },
    { source: 'oferta-torvik-akall', target: 'froya', label: 'objetivo: vengar a', type: 'trama' },
    { source: 'galdur-vs-seidr', target: 'skalk', label: 'postura de', type: 'lore' },
    { source: 'galdur-vs-seidr', target: 'vol', label: 'objetivo implícito de la crítica de', type: 'conflict' },
    { source: 'galdur-vs-seidr', target: 'sulich', label: 'refutado por', type: 'conflict' },
    { source: 'skalk', target: 'sulich', label: 'amenazó con «resolver en Darl» a', type: 'conflict' },
    { source: 'varg', target: 'pelo-froya', label: 'reveló a Torvik', type: 'event' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 40 — NUEVOS ENLACES (CIERRE DEL LIBRO)
    // ══════════════════════════════════════════════════════════════
    { source: 'emboscada-granja', target: 'orka', label: 'forzó la huida de', type: 'event' },
    { source: 'emboscada-granja', target: 'gudvarr', label: 'liderada por', type: 'event' },
    { source: 'emboscada-granja', target: 'mord-lif', label: 'obligó a huir a', type: 'event' },
    { source: 'emboscada-granja', target: 'sigrun', label: 'drengrs de Sigrún en la', type: 'event' },
    { source: 'emboscada-granja', target: 'arild', label: 'Arild presente en la', type: 'event' },
    { source: 'fuga-norte-grimholt', target: 'orka', label: 'protagoniza la', type: 'event' },
    { source: 'fuga-norte-grimholt', target: 'gudvarr', label: 'perseguidor en la', type: 'event' },
    { source: 'fuga-norte-grimholt', target: 'mord-lif', label: 'compañeros de huida en la', type: 'event' },
    { source: 'fuga-norte-grimholt', target: 'grimholt', label: 'destino final de la', type: 'geo' },
    { source: 'trur', target: 'orka', label: 'montura de', type: 'rel' },
    ...
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 45 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'traicion-skalk', target: 'skalk', label: 'ejecutada por', type: 'event' },
    { source: 'traicion-skalk', target: 'torvik', label: 'Torvik asesinado en la', type: 'event' },
    { source: 'traicion-skalk', target: 'vol', label: 'Vol capturada en la', type: 'event' },
    { source: 'traicion-skalk', target: 'varg', label: 'Varg víctima de la', type: 'event' },
    { source: 'traicion-skalk', target: 'olvir-yrsa', label: 'Olvir muerto por Varg en la', type: 'event' },
    { source: 'traicion-skalk', target: 'camara-rotta', label: 'escenario de la', type: 'geo' },
    { source: 'varg-akall-promesa-vol', target: 'vol', label: 'Vol acepta en', type: 'event' },
    { source: 'varg-akall-promesa-vol', target: 'varg', label: 'Varg revela su historia en', type: 'event' },
    { source: 'varg-akall-promesa-vol', target: 'froya', label: 'objetivo del', type: 'trama' },
    { source: 'vol-uspa-hermanas', target: 'vol', label: 'hermana de', type: 'rel' },
    { source: 'vol-uspa-hermanas', target: 'uspa', label: 'hermana de', type: 'rel' },
    { source: 'vol-uspa-hermanas', target: 'ella-misteriosa', label: 'resuelve el misterio de', type: 'trama' },
    { source: 'camara-rotta', target: 'rotta', label: 'lugar de punición de', type: 'lore' },
    { source: 'camara-rotta', target: 'cueva-boneback', label: 'interior de la', type: 'geo' },
    { source: 'camara-rotta', target: 'ninos-robados', label: 'cámara de niños encontrada en la', type: 'trama' },
    { source: 'raudskinna', target: 'rotta', label: 'Galdrabok de', type: 'lore' },
    { source: 'raudskinna', target: 'skalk', label: 'posiblemente en el cofre de', type: 'trama' },
    { source: 'espada-hueso', target: 'orna', label: 'garra de', type: 'lore' },
    { source: 'skalk', target: 'vol', label: 'capturó a', type: 'event' },
    { source: 'skalk', target: 'espada-hueso', label: 'tomó la', type: 'event' },
    { source: 'skalk', target: 'raudskinna', label: 'posiblemente tiene la', type: 'trama' },
    { source: 'varg', target: 'olvir-yrsa', label: 'mató a Olvir', type: 'event' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 46 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'altar-lik-rifa-boneback', target: 'lik-rifa-amenaza', label: 'confirma el culto activo de', type: 'trama' },
    { source: 'altar-lik-rifa-boneback', target: 'orka', label: 'descubierto por', type: 'event' },
    { source: 'altar-lik-rifa-boneback', target: 'grimholt', label: 'en la ruta al', type: 'geo' },
    { source: 'altar-lik-rifa-boneback', target: 'orna', label: 'profana símbolo de', type: 'lore' },
    { source: 'teoria-lik-rifa-liberacion', target: 'orka', label: 'hipótesis activa de', type: 'trama' },
    { source: 'teoria-lik-rifa-liberacion', target: 'lik-rifa-amenaza', label: 'desarrolla la amenaza de', type: 'trama' },
    { source: 'teoria-lik-rifa-liberacion', target: 'ninos-robados', label: 'posible función ritual de los', type: 'trama' },
    { source: 'teoria-lik-rifa-liberacion', target: 'drekr', label: 'posible agente de', type: 'trama' },
    { source: 'leccion-drengr', target: 'orka', label: 'enseñada por', type: 'event' },
    { source: 'leccion-drengr', target: 'mord-lif', label: 'aprendida por', type: 'event' },
    { source: 'leccion-drengr', target: 'gudvarr', label: 'se aplicará contra', type: 'trama' },
    { source: 'orka', target: 'teoria-lik-rifa-liberacion', label: 'formula la', type: 'trama' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 47 — NUEVOS ENLACES (CIERRE DEL LIBRO)
    // ══════════════════════════════════════════════════════════════
    { source: 'juramento-varg-bloodsworn', target: 'varg', label: 'tomado por', type: 'event' },
    { source: 'juramento-varg-bloodsworn', target: 'glornir', label: 'administrado por', type: 'event' },
    { source: 'juramento-varg-bloodsworn', target: 'bloodsworn', label: 'une a Varg al', type: 'event' },
    { source: 'bloodsworn-linajes-tainted', target: 'bloodsworn', label: 'estructura interna del', type: 'lore' },
    { source: 'bloodsworn-linajes-tainted', target: 'tainted', label: 'todos descendientes de dioses', type: 'lore' },
    { source: 'bloodsworn-linajes-tainted', target: 'glornir', label: 'Glornir: Berser-kin en el', type: 'lore' },
    { source: 'bloodsworn-linajes-tainted', target: 'svik', label: 'Svik: Refur-kin en el', type: 'lore' },
    { source: 'bloodsworn-linajes-tainted', target: 'rokia', label: 'Røkia: Úlfhéðnar en el', type: 'lore' },
    { source: 'bloodsworn-linajes-tainted', target: 'edel', label: 'Edel: Hundur-kin en el', type: 'lore' },
    { source: 'bloodsworn-linajes-tainted', target: 'jokul', label: 'Jökul: Gröfu-kin en el', type: 'lore' },
    { source: 'bloodsworn-linajes-tainted', target: 'varg', label: 'Varg: Úlfhéðnar en el', type: 'lore' },
    { source: 'vol-glornir-matrimonio', target: 'vol', label: 'esposa en el', type: 'rel' },
    { source: 'vol-glornir-matrimonio', target: 'glornir', label: 'esposo en el', type: 'rel' },
    { source: 'glornir', target: 'vol', label: 'esposa de', type: 'rel' },
    { source: 'rokia', target: 'varg', label: 'hermanados como Úlfhéðnar', type: 'rel' },
    { source: 'varg', target: 'skalk', label: 'juraron venganza los Bloodsworn sobre', type: 'trama' },
    { source: 'bloodsworn', target: 'skalk', label: 'persiguen a', type: 'trama' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 48 — NUEVOS ENLACES (FINAL ABSOLUTO)
    // ══════════════════════════════════════════════════════════════
    { source: 'vorn-askasdottir', target: 'oskutred', label: 'guarda el', type: 'rel' },
    { source: 'vorn-askasdottir', target: 'aska-froa', label: 'hija de', type: 'rel' },
    { source: 'vorn-askasdottir', target: 'trapdoor-oskutred', label: 'defiende la', type: 'trama' },
    { source: 'vorn-askasdottir', target: 'hijas-orna-ulfrir', label: 'menciona a las', type: 'lore' },
    { source: 'trapdoor-oskutred', target: 'lik-rifa-amenaza', label: 'prisión de Lik-Rifa bajo la', type: 'trama' },
    { source: 'trapdoor-oskutred', target: 'oskutred', label: 'parte de', type: 'geo' },
    { source: 'bosque-horca', target: 'oskutred', label: 'antesala de', type: 'geo' },
    { source: 'bosque-horca', target: 'orna', label: 'venganza de Orna en el', type: 'lore' },
    { source: 'bosque-horca', target: 'lik-rifa-amenaza', label: 'dragon-born ejecutados en el por Lik-Rifa', type: 'lore' },
    { source: 'llegada-ilska-oskutred', target: 'ilska', label: 'llegada de', type: 'event' },
    { source: 'llegada-ilska-oskutred', target: 'oskutred', label: 'escenario de la', type: 'geo' },
    { source: 'llegada-ilska-oskutred', target: 'battle-grim', label: 'confronta a los', type: 'trama' },
    { source: 'linajes-tainted-terrores', target: 'vorn-askasdottir', label: 'identificados por', type: 'event' },
    { source: 'linajes-tainted-terrores', target: 'biorr', label: 'Rotta-kin candidato en los', type: 'trama' },
    { source: 'linajes-tainted-terrores', target: 'uspa', label: 'Snaka-kin candidata en los', type: 'trama' },
    { source: 'elvar', target: 'ulfrir', label: 'encontró el esqueleto de', type: 'event' },
    { source: 'battle-grim', target: 'oskutred', label: 'llegó a', type: 'event' },
    { source: 'ilska', target: 'oskutred', label: 'llegó a', type: 'event' },
    { source: 'ulfrir', target: 'oskutred', label: 'esqueleto en la llanura de', type: 'geo' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 49 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'emboscada-grimholt-bosque', target: 'cat-eventos', label: '', type: 'event' },
    { source: 'emboscada-grimholt-bosque', target: 'orka', label: 'protagoniza / noqueada en', type: 'event' },
    { source: 'emboscada-grimholt-bosque', target: 'skalk', label: 'noquea a Orka en', type: 'event' },
    { source: 'emboscada-grimholt-bosque', target: 'vol', label: 'inconsciente y capturada durante', type: 'event' },
    { source: 'emboscada-grimholt-bosque', target: 'mord-lif', label: 'Mord mata a un guerrero en', type: 'event' },
    { source: 'emboscada-grimholt-bosque', target: 'grimholt', label: 'ocurre en bosques cercanos al', type: 'geo' },
    { source: 'emboscada-grimholt-bosque', target: 'araña-hielo', label: 'combate contra', type: 'event' },
    { source: 'emboscada-grimholt-bosque', target: 'cuervos-gigantes', label: 'rescate mutuo con', type: 'event' },
    { source: 'cuervos-gigantes', target: 'cat-orka', label: '', type: 'arc' },
    { source: 'cuervos-gigantes', target: 'orka', label: 'salvados por / salvan a', type: 'event' },
    { source: 'cuervos-gigantes', target: 'araña-hielo', label: 'atrapados por / matan a', type: 'event' },
    { source: 'orka', target: 'grimholt', label: 'reconoció y fue noqueada cerca del', type: 'event' },
    { source: 'orka', target: 'skalk', label: 'noqueada por sin saber quién es', type: 'event' },
    { source: 'skalk', target: 'grimholt', label: 'pasa por los bosques del', type: 'geo' },
    { source: 'araña-hielo', target: 'grimholt', label: 'nidos en bosques cercanos al', type: 'geo' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 50 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'holmganga-oskutred', target: 'cat-eventos', label: '', type: 'event' },
    { source: 'holmganga-oskutred', target: 'agnar', label: 'combatiente y muerto en', type: 'event' },
    { source: 'holmganga-oskutred', target: 'skrid', label: 'combatiente y muerto en', type: 'event' },
    { source: 'holmganga-oskutred', target: 'ilska', label: 'propuesta por', type: 'event' },
    { source: 'holmganga-oskutred', target: 'oskutred', label: 'ocurre en', type: 'geo' },
    { source: 'holmganga-oskutred', target: 'dragon-born', label: 'confirma linaje de Skrið como', type: 'lore' },
    { source: 'skrid', target: 'ilska', label: 'hermano de', type: 'rel' },
    { source: 'skrid', target: 'drekr', label: 'hermano de', type: 'rel' },
    { source: 'skrid', target: 'raven-feeders', label: 'miembro de', type: 'rel' },
    { source: 'skrid', target: 'dragon-born', label: 'es', type: 'lore' },
    { source: 'ilska', target: 'drekr', label: 'hermana de', type: 'rel' },
    { source: 'ilska', target: 'dragon-born', label: 'toda su familia es', type: 'lore' },
    { source: 'ilska', target: 'oskutred', label: 'llega con niños Tainted a', type: 'event' },
    { source: 'drekr', target: 'raven-feeders', label: 'hermano de Ilska / miembro de', type: 'rel' },
    { source: 'drekr', target: 'dragon-born', label: 'confirmado como', type: 'lore' },
    { source: 'traicion-biorr', target: 'cat-eventos', label: '', type: 'event' },
    { source: 'traicion-biorr', target: 'biorr', label: 'protagoniza', type: 'event' },
    { source: 'traicion-biorr', target: 'agnar', label: 'asesinado en', type: 'event' },
    { source: 'traicion-biorr', target: 'oskutred', label: 'ocurre en', type: 'geo' },
    { source: 'traicion-biorr', target: 'raven-feeders', label: 'Biórr trabaja para', type: 'trama' },
    { source: 'biorr', target: 'agnar', label: 'asesinó a', type: 'event' },
    { source: 'biorr', target: 'raven-feeders', label: 'traidor / agente de', type: 'trama' },
    { source: 'ninos-robados', target: 'oskutred', label: 'niños llevados a', type: 'trama' },
    { source: 'bjarn', target: 'oskutred', label: 'llevado por Ilska a', type: 'event' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 51 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'masacre-grimholt', target: 'cat-eventos', label: '', type: 'event' },
    { source: 'masacre-grimholt', target: 'orka', label: 'protagoniza', type: 'event' },
    { source: 'masacre-grimholt', target: 'grimholt', label: 'ocurre en', type: 'geo' },
    { source: 'masacre-grimholt', target: 'skapti', label: 'interroga a Orka en', type: 'event' },
    { source: 'masacre-grimholt', target: 'gudvarr', label: 'mata a Mord en', type: 'event' },
    { source: 'masacre-grimholt', target: 'mord-lif', label: 'Mord muerto en', type: 'event' },
    { source: 'masacre-grimholt', target: 'skalk', label: 'herido por Orka en', type: 'event' },
    { source: 'masacre-grimholt', target: 'cuervos-gigantes', label: 'rescatan a Orka en', type: 'event' },
    { source: 'masacre-grimholt', target: 'spert', label: 'combate en', type: 'event' },
    { source: 'masacre-grimholt', target: 'vesli', label: 'combate en', type: 'event' },
    { source: 'skapti', target: 'grimholt', label: 'comandante de', type: 'rel' },
    { source: 'skapti', target: 'hakon', label: 'obedece órdenes de', type: 'rel' },
    { source: 'skapti', target: 'drekr', label: 'deja pasar a', type: 'rel' },
    { source: 'skapti', target: 'ninos-robados', label: 'facilita el paso de', type: 'trama' },
    { source: 'gudvarr', target: 'mord-lif', label: 'mató a Mord', type: 'event' },
    { source: 'orka', target: 'ulfhednar', label: 'transformación completa confirmada como', type: 'lore' },
    { source: 'cuervos-gigantes', target: 'spert', label: 'trajeron a Orka', type: 'event' },
    { source: 'cuervos-gigantes', target: 'vesli', label: 'trajeron a Orka', type: 'event' },
    { source: 'skalk', target: 'grimholt', label: 'herido y huye del', type: 'event' },
    { source: 'gudvarr', target: 'grimholt', label: 'llega al / huye del', type: 'event' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 52 — NUEVOS ENLACES
    // ══════════════════════════════════════════════════════════════
    { source: 'liberacion-lik-rifa', target: 'cat-eventos', label: '', type: 'event' },
    { source: 'liberacion-lik-rifa', target: 'likrafa', label: 'libera a', type: 'event' },
    { source: 'liberacion-lik-rifa', target: 'ilska', label: 'ejecutado por', type: 'event' },
    { source: 'liberacion-lik-rifa', target: 'raudskinna', label: 'ritual leído de la', type: 'magic' },
    { source: 'liberacion-lik-rifa', target: 'oskutred', label: 'ocurre en', type: 'geo' },
    { source: 'liberacion-lik-rifa', target: 'ninos-robados', label: 'niños usados como combustible en', type: 'trama' },
    { source: 'liberacion-lik-rifa', target: 'hijas-orna-ulfrir', label: 'dos mueren en', type: 'event' },
    { source: 'liberacion-lik-rifa', target: 'drekr', label: 'mata a hija dorada en', type: 'event' },
    { source: 'likrafa', target: 'nastrandir', label: 'vuela hacia', type: 'geo' },
    { source: 'likrafa', target: 'hijas-orna-ulfrir', label: 'mató a la hija blanca / combatida por', type: 'event' },
    { source: 'hijas-orna-ulfrir', target: 'orna', label: 'hijas de', type: 'rel' },
    { source: 'hijas-orna-ulfrir', target: 'ulfrir', label: 'hijas de', type: 'rel' },
    { source: 'hijas-orna-ulfrir', target: 'oskutred', label: 'carceleras bajo', type: 'rel' },
    { source: 'hijas-orna-ulfrir', target: 'likrafa', label: 'carceleras de', type: 'rel' },
    { source: 'hijas-orna-ulfrir', target: 'lik-rifa-amenaza', label: 'última defensa contra', type: 'rel' },
    { source: 'biorr', target: 'rotta', label: 'sangre Tainted de', type: 'lore' },
    { source: 'biorr', target: 'kraka', label: 'liberó del collar a', type: 'event' },
    { source: 'biorr', target: 'hundur', label: 'liberó del collar a (Ilmur)', type: 'event' },
    { source: 'biorr', target: 'thrud', label: 'mató a (confesado)', type: 'event' },
    { source: 'kraka', target: 'raven-feeders', label: 'se une a', type: 'event' },
    { source: 'hundur', target: 'raven-feeders', label: 'Ilmur se une a', type: 'event' },
    { source: 'grend', target: 'battle-grim', label: 'toma el mando de', type: 'event' },
    { source: 'ilska', target: 'likrafa', label: 'liberó a / se arrodilla ante', type: 'event' },
    { source: 'raudskinna', target: 'liberacion-lik-rifa', label: 'usada en el ritual de', type: 'magic' },
    // ══════════════════════════════════════════════════════════════
    // CAPÍTULO 53 — NUEVOS ENLACES (EPÍLOGO)
    // ══════════════════════════════════════════════════════════════
    { source: 'convergencia-grimholt', target: 'cat-eventos', label: '', type: 'event' },
    { source: 'convergencia-grimholt', target: 'orka', label: 'encontrada por Bloodsworn en', type: 'event' },
    { source: 'convergencia-grimholt', target: 'glornir', label: 'reconoce a Orka en', type: 'event' },
    { source: 'convergencia-grimholt', target: 'varg', label: 'presente en', type: 'event' },
    { source: 'convergencia-grimholt', target: 'grimholt', label: 'ocurre en', type: 'geo' },
    { source: 'convergencia-grimholt', target: 'bloodsworn', label: 'llega al Grimholt en', type: 'event' },
    { source: 'orka', target: 'glornir', label: 'cuñada de (Thorkel era su hermano)', type: 'rel' },
    { source: 'orka', target: 'skullsplitter', label: 'esposa de / es Orka Skullsplitter', type: 'rel' },
    { source: 'thorkel', target: 'glornir', label: 'hermano de (= Skullsplitter)', type: 'rel' },
    { source: 'thorkel', target: 'skullsplitter', label: 'ES Skullsplitter', type: 'rel' },
    { source: 'glornir', target: 'thorkel', label: 'hermano de (= Skullsplitter)', type: 'rel' },
    { source: 'varg', target: 'edel', label: 'ofrecido puesto de scout por', type: 'rel' },
    // ══════════════════════════════════════════════════════════════
    // CAST LIST (LIBRO 2) — ENLACES CONFIRMADOS
    // ══════════════════════════════════════════════════════════════
    { source: 'myrk', target: 'ilska', label: 'hermana menor de', type: 'rel' },
    { source: 'myrk', target: 'drekr', label: 'hermana de', type: 'rel' },
    { source: 'myrk', target: 'raven-feeders', label: 'miembro de', type: 'rel' },
    { source: 'myrk', target: 'dragon-born', label: 'es', type: 'lore' },
    { source: 'estrid', target: 'helka', label: 'hija de', type: 'rel' },
    { source: 'estrid', target: 'hakon', label: 'hermana de', type: 'rel' },
    { source: 'orka', target: 'bloodsworn', label: 'fue jefa de (= Skullsplitter)', type: 'rel' },
