...
const nodes = [
    ...
    {
        id: 'elvar', label: 'Elvar', group: 'ELVAR', type: 'POV — Personaje', desc: 'Guerrera más joven de Terrores de la batalla. Rubia, trenza guerrera, escudo rojo con armas cruzadas. Impulsiva y valiente hasta la temeridad. Siempre trata de hacer más que los demás, así ganó su puesto en el muro de escudos. Saltó al mar helado para salvar al hijo de Berak. Escéptica empírica: solo cree en lo que puede ver y tocar. Acepta los Tainted por evidencia directa pero negaba los dragon-born (ver nodo dragon-born). Sobrevive al ataque de wyrms con ayuda de Grend y Agnar (ver nodo night-wyrm). Lleva colmillo de trol al cuello como distinción de Terrores de la batalla (ver nodo colmillo-trol). Llegó a Snakavik con Agnar. Huyó de Snakavik para escapar del sentimiento de insignificancia que le provoca ese lugar. Jarl Störr es su padre (ver nodo storr). Hrung la reconoció por el olfato antes de que se quitara la capucha. Su respuesta fue fría y escueta: "Hola, padre." (ver nodo llegada-snakavik).',
        star: '★★★ Störr es su padre. La reacción emocional ante el nombre de Snakavik, su huida de casa para unirse a Terrores de la batalla — todo encaja. Una hija de jarl que huyó para no sentirse como una tuerca en un cubo de tuercas.'
    },
    {
    ...
    {
        id: 'grend', label: 'Grend', group: 'ELVAR', type: 'Personaje — Guardián', desc: 'Guerrero mayor. Cabello negro trenzado, barba gris. Siempre junto a Elvar. No es su padre (él lo niega). Lacónico; su cara no traiciona lo que siente. Salta al mar helado tras Elvar. Le sirve gachas y le cubre los turnos de guardia. Armado con hacha y seax en su cinturón de armas. Llegó a Snakavik con Agnar. Snakavik fue su hogar por más años de los que Elvar ha vivido — aunque la vista del cráneo de Snaka no alteró ni una sola línea de su expresión. Su lealtad a Elvar cobra un significado nuevo ahora que se sabe que ella es la hija de Jarl Störr.',
    ...
    {
        id: 'storr', label: 'Jarl Störr', group: 'FACCION', type: 'Facción — Amenaza', desc: 'Jarl poderoso del noroeste, sede en Snakavik. En expansión constante hacia el sur y el este. Alto, delgado, túnica de lana azul oscuro con tejido tablet en cuello y bajos, cinturón con hebilla de plata, seax finamente trabajado. Cadena de plata al cuello con colmillo de serpiente colgando. Anillo de brazo de plata grueso con serpiente-que-se-muerde-la-cola. Cabello oscuro con toques de plata, recogido y atado en la nuca. Barba ordenada con una trenza unida con aro de plata. Cejas pesadas y caídas que sombrean sus ojos. Nariz fina y afilada. Carácter: señor estricto, intolerado, poco complaciente — su reino prospera y el comercio fluye, pero los infractores acaban en jaulas de hierro exhibidas en el muelle. Guardia personal: una docena de Berserkir-thralls con collares de thrall, colgantes de garra de oso de hierro, cabellos trenzados con hilo de oro y plata, barbas perfumadas con aceite. Una agente seiðr de confianza: Silrið (ver nodo silrid). Un oráculo en su sala de festines: la cabeza gigante de piedra Hrung (ver nodo hrung). Compró a Berak pagando el doble del precio de mercado. Padre biológico de Elvar.',
        star: '★★★ Störr es el padre de Elvar. Hrung la olió antes de que se quitara la capucha. La dinámica padre-hija en la narrativa está apenas abierta — y cargada de tensión.'
    },
    {
    ...
    },
    {
        ...
        desc: 'Mujer rubia, mayor que los hombres jóvenes que flanquean a Störr. Collar de huesos alrededor del cuello. Tatuajes de runas densos en el dorso de las manos y desapareciendo en las mangas de su túnica de lana amarilla. Armada con un seax más corto de lo habitual — no es arma de muro de escudos sino de uso ritual o íntimo. Calzas de cuero cruzadas con cordones en las piernas. Actúa como verificadora de linaje para Störr: con la sangre de Berak en el seax, se acerca al oráculo Hrung, lo despierta con una patada en el mentón y un "vaknaðu" y pone el filo con sangre sobre la lengua del gigante. Es de confianza absoluta de Störr — él la llama solo por su nombre. Su conocimiento del Seiðr permite despertar y comunicarse con Hrung. [Paralelo histórico: las völur nórdicas eran practicantes de Seiðr que servían a líderes; Silrið funciona como völva privada de Störr, combinando divinación de linaje con servicio de corte. El Seiðr histórico incluía "buscar lo oculto" — aquí aplicado a revelar sangre divina en la sangre de un individuo.]',
        star: '★★ Primera völva libre (no encadenada) que vemos en Vigríð. A diferencia de Kráka y Vol, Silrið no lleva collar de thrall. ¿Es su posición de privilegio excepcional, o hay Seiðr libres que Terrores de la batalla y los Bloodsworn aún no han encontrado?'
    },
    {
