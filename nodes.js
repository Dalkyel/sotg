...
const nodes = [
    ...
    {
        id: 'breca', label: 'Breca (RAPTADO)', group: 'ORKA', type: 'Personaje -- Orka (Desaparecido)', desc: '10 inviernos. Pelo negro como cuervo, ojos de Orka. Sensible, curioso, valiente. Vinculado a Vesli por juramento de sangre. Lleva colgante de madera con forma de espada. Cap.17: RAPTADO por la banda de Drekr durante el ataque al steading. Thorkel (moribundo) confirma que se lo llevaron vivo. Un joven interrogado por Orka dice que fue llevado en el rio -- en los dos botes que ya partieron. Hay sangre entre las huellas que llevan al bote, posiblemente de heridas del propio Breca o de sus captores. Destino desconocido: el rio se bifurca en dos canales pasado un peñasco de granito.',
    ...
    {
        id: 'likrafa', label: 'Lik-Rifa (Diosa-Dragon)', group: 'DIOS', type: 'Dios -- Viva (Encadenada)', desc: 'La diosa-dragon, hija de Snaka. NO murio en el Gudfalla: fue encadenada bajo Osktured, el Arbol de Ceniza. Su causa en el Gudfalla: mato a la hija de Orna por paranoia alimentada por Rotta; creo los vaesen en secreto. Cap.14: Elvar dice que los dragon-born son un cuento -- Uspa escupe. Cap.17: CONFIRMACION DEFINITIVA de dragon-born. Thorkel, moribundo tras defender el steading contra la banda de Drekr, usa su ultimo aliento para decir Dragon-born. Al menos uno de los Tainted de Lik-Rifa existe y opera activamente en Vigrið, trabajando para Drekr en el rapto de ninos.',
        star: '*** Cap.17: los dragon-born son REALES. Thorkel los confirma muriendo. La pregunta ahora es: cuantos hay, quien es el que trabajo con Drekr, y que relacion tienen con Lik-Rifa encadenada bajo Osktured. ¿Es la red de Drekr una operacion para beneficiar a Lik-Rifa de alguna forma?'
    },
    {
    ...
    {
        id: 'ninos-robados', label: 'Robos de Ninos', group: 'TRAMA', type: 'Trama -- Abierta (Urgente)', desc: 'Patron organizado bajo el mando de Drekr. Casos conocidos: Harek (colinas de Fellur), 3 hijos de los Haraldurson (Howbyr), familia de Kergarth, y ahora BRECA. Cap.17: patron de operacion confirmado -- queman la proteccion galdr-runica (necesitan un Galdurman o Seidr-witch), atacan con fuerza numerosa, huyen en botes por los rios. Thorkel siguio sus rastros tras el caso Asgrim: tres botes entonces; en Cap.17 quedan huellas de tres botes (uno recuperado por Orka en el rio, dos ya partidos con Breca y los supervivientes). El interrogado revelo que el lider se llama Drekr. Los captores llevan a los ninos vivos -- algun proposito especifico.',
        star: '*** Cap.17: trama escalada al maximo. Drekr es el nombre del antagonista. Breca es el ultimo raptado. El rio se bifurca -- Orka no sabe que camino tomaron. La red es mucho mayor de lo que parecia: necesitan magia (Galdurman) para romper protecciones.'
    },
    {
    ...
    {
        id: 'orka', label: 'Orka', group: 'ORKA', type: 'POV -- Personaje', desc: 'Mujer alta y rubia, ojos gris-verde. Exguerrera. Flashbacks violentos, episodios de rabia cegadora. Padre violento en la infancia. Capturo a Spert mediante vinculo de sangre. Cap.15: decide huir del steading. Encuentra a Froa muerta. Escucha gritos al oeste. Cap.17: llega al steading en llamas. Encuentra el rastro de la batalla: Spert herido junto al arroyo rodeado de tennur muertos, galdr-runas destruidas (un Galdurman o Seidr-witch participo en el ataque), Thorkel agonizando en el centro de un monton de 5-6 cuerpos que el solo mato. Thorkel muere en sus brazos diciendo Dragon-born. Orka frota su sangre sobre su propia cara en franjas de frente a menton -- ritual de duelo y guerra. Le coloca el hacha larga en las manos para el mas alla. Persigue las huellas hasta el rio: mata a cuatro de los rezagados (uno con lanza en la espalda, uno viejo con seax en el vientre y tripas fuera, la mujer con hacha repetida hasta pulpa -- en un acceso de rabia feral --). Interroga al chico joven hasta obtener el nombre del lider: Drekr. Lo mata. Queda sola junto al rio con el nombre de quien le robo al hijo y mato al marido.',
        star: '*** Cap.17: transformacion completa. El personaje que intentaba vivir en paz se convierte en maquina de venganza. La escena de la mujer a hachazos es la primera vez que vemos el lado verdaderamente oscuro de Orka -- no defensa, sino furia pura. Ahora tiene un objetivo: Drekr.'
    },
    {
    ...
    {
        id: 'spert', label: 'Spert', group: 'ORKA', type: 'Vaesen -- Guardian (Herido)', desc: 'Spertus. Artropodo segmentado con cara casi humana, aguijon, antenas, vapor negro venenoso. Capturado por Orka con vinculo de sangre. Guarda el steading. Come papilla de sangre y saliva de Orka diariamente. Cap.17: encontrado tendido sobre la roca junto al arroyo, inmovil, con un agujero en su cuerpo segmentado del que mana icor negro. Rodeado de una docena de cuerpos de tennur vaesen -- tambien muertos. Aparentemente muerto o moribundo. Orka no tiene tiempo de atenderlo.',
    ...
    {
        id: 'steading', label: 'Steading (Granja)', group: 'NORSE', type: 'Vida Diaria -- Vivienda', desc: 'Granja autosuficiente. Casa principal, establos, almacenes, cercas. Unidad basica de vida rural. Orka y Thorkel construyeron su steading en las colinas sobre Fellur con sus propias manos. Asgrim tenia steading donde fue asesinado. Cap.17: el steading de Orka fue DESTRUIDO -- hall incendiado (techo colapsado), galdr-runas de proteccion quemadas y obliteradas, animales muertos (gallinas, cabras), establo abierto y vacio, Snort el pony robado y luego matado en el rio.',
    ...
    {
        id: 'thorkel', label: 'Thorkel Ulfsson (dagger)', group: 'ORKA', type: 'Personaje -- MUERTO', desc: 'Grande como un penasco. Barba trenzada con cicatriz de mejilla a mandibula. Ex-thrall. El mejor rastreador. Profundamente amoroso con Orka y Breca. Hacha de mango largo con hoja barbada. Capa de lobo. Identifico a la thrall de Sigrun como Ulfhednar. Acepto la huida sin resistencia. Cap.17: MUERTO. Defendio el steading solo contra la banda de Drekr mientras Orka no estaba. Retrocedio hasta el hall, barro la puerta y los aguanto en el umbral mas estrecho donde el numero no contaba. Mato a cinco o seis atacantes -- uno con el hacha partida en el craneo de corona a menton. Los asaltantes lo apunalaron con dos seaxes (uno en el pecho alto, uno en el vientre). Orka lo encuentra en el centro del monton de cadaveres, aun respirando apenas. Ultimas palabras: They took Breca (no pude detenerlos) y luego, como susurro: Dragon-born. Orka le coloca el hacha larga en las manos para sus ritos funerarios y lo deja atras al perseguir a los raptores.',
        star: '*** MUERTO en Cap.17. Sus dos ultimas palabras son los hallazgos narrativos mas importantes del libro hasta ahora: (1) confirma que Drekr se llevo a Breca vivo, (2) Dragon-born -- murio combatiendo a un Tainted de linaje de Lik-Rifa. Elvar estaba equivocada. Uspa tenia razon. El dragon-born existe y esta operando en Vigrið.'
    },
    {
    ...
    {
        id: 'vesli', label: 'Vesli', group: 'ORKA', type: 'Vaesen -- Aliada de Breca (Herida)', desc: 'Tennur hembra. Pequena, alas membranosas, dos filas de dientes, venas oscuras en piel rosada. Herida y expulsada de su manada. Breca la salvo. Juro lealtad de sangre al nino. Integrada en la familia de Orka. Cap.17: encontrada bajo un cuerpo en el hall en llamas, alas sueltas, cara y cabeza empapadas en sangre. Inmovil. Orka la recoge creyendola muerta. Cuando Orka regresa al hall a por la lanza de Thorkel, Vesli da senales de vida -- se mueve. Orka la recoge de nuevo. Todavia con vida pero en estado grave. Orka la deja junto al cuerpo de Thorkel al salir a perseguir las huellas.',
    ...
    {
        id: 'dragon-born', label: 'Dragon-Born (Tainted de Lik-Rifa)', group: 'TRAMA', type: 'Trama -- CONFIRMADA', desc: 'Tainted con sangre de la diosa-dragon Lik-Rifa. Cap.14: Elvar arguye que nunca se ha confirmado ninguno -- nadie en sus viajes lo ha visto. Uspa escupe. Cap.17: CONFIRMACION DEFINITIVA. Las ultimas palabras de Thorkel (moribundo tras defender el steading) son: Dragon-born. Thorkel, el mejor rastreador e identificador de Tainted de los Hermanos conocidos, murio combatiendo a alguien de linaje dragon. Eso significa que Drekr opera con al menos un dragon-born en su banda. Elvar estaba completamente equivocada. Uspa lo sabia.',
        star: '*** CONFIRMADO en Cap.17. Thorkel lo dice con su ultimo aliento -- el hombre que identifico a una Ulfhednar sin titubear no se equivocaria en esto. Un dragon-born (Tainted de Lik-Rifa) esta activo en Vigrið, trabajando para Drekr. Cambia toda la cosmologia del libro.'
    },
