...
const nodes = [
    ...
    {
        id: 'glornir', label: 'Glornir', group: 'VARG', type: 'Personaje -- Jefe', desc: 'Jefe de los Hermanos de Sangre. Calvo, barba gris trenzada. Long-axe como baston. Oro y plata en brazos y cuello. Habla lengua Galdur. Epítetos: Rompe-Escudos, Dador-de-Oro, Robador-de-Almas, Cortador-Golpeador-Aplastador. Filosofia del Bloodsworn: habilidad + lealtad + devocion. Lleva brynja brillante y yelmo al salir de Liga. Da a Varg la lanza de Aslog y el escudo negro. En el muelle, Jaromir le dispara una flecha directamente -- Glornir la derriba en el aire con un golpe de hacha que deja boquiabiertos a los druzhina. Grita SHIELD WALL cuando carga la caballeria. Se niega por segunda vez a entregar a Sulich bajo amenaza directa.',
    ...
    {
        id: 'varg', label: 'Varg', group: 'VARG', type: 'POV -- Personaje', desc: 'Ex-thrall de Snepil, ~30 inviernos. Hermana Froya muerta. Episodios de furia roja. Boxeador formidable. Bolsa de cuero con algo de Froya. Aprendiz de los Hermanos. Compra equipo en Liga con Svik y Rokia: tunicas, pantalones, winnigas, zapatos, gorra de nalbinding, seax, hacha de lanzar, yelmo de cuatro placas con forro de piel, instrumental medico, capa de foca. Recibe la lanza de Aslog (Hermano caido) de Glornir y el escudo negro de entrenamiento. Primera batalla real en muelles contra druzhina de Jaromir: olvida quitar la cubierta de cuero de la lanza, sube a un caballo por primera vez, mata a un druzhina hundiendole el seax por grieta en armadura laminar. Primero en ver la flota de Helka.',
        star: '*** primera muerte en combate. La cubierta de la lanza es el error mas revelador: instinto de combate bueno, tecnica todavia en construccion. Subir al caballo sin haberlo hecho nunca -- reaccion pura. La sensacion extraña del relic en la viga confirma posible sensibilidad magica.'
    },
    {
    ...
    {
        id: 'vesli', label: 'Vesli', group: 'ORKA', type: 'Vaesen -- Aliada de Breca (Herida)', desc: 'Tennur hembra. Pequena, alas membranosas, dos filas de dientes, venas oscuras en piel rosada. Herida y expulsada de su manada. Breca la salvo. Juro lealtad de sangre al nino. Integrada en la familia de Orka. Encontrada bajo un cuerpo en el hall en llamas, alas sueltas, cara y cabeza empapadas en sangre. Inmovil. Orka la recoge creyendola muerta. Cuando Orka regresa al hall a por la lanza de Thorkel, Vesli da senales de vida -- se mueve. Orka la recoge de nuevo. Todavia con vida pero en estado grave. Orka la deja junto al cuerpo de Thorkel al salir a perseguir las huellas.',
